...
export const processingExcelData = (data: originalExcelFile[], cumulativeStockData: baseDataBeforeProcess["cumulativeStockData"]) => {
    ...
    data.forEach(item => {
        ...
        const dayValue: ExcelData = {
            ...
            indivDispersionRatio: calcPercent(volume.indivCollectionVolume, ( cumulativeStockData.cumulativeIndivMount + cumulativeStockData.maxIndivMount - cumulativeStockData.minIndivMount )),
            ...
            totalForeAndInstDispersionRatio: calcPercent(volume.totalForeAndInstCollectionVolume, ( cumulativeStockData.cumulativeTotalForeAndInstMount + cumulativeStockData.maxTotalForeAndInstMount - cumulativeStockData.
            ...
            foreDispersionRatio: calcPercent(volume.foreCollectionVolume, (cumulativeStockData.cumulativeForeMount + cumulativeStockData.maxForeMount - cumulativeStockData.minForeMount)),
            ...
            totalInsDispersionRatio: calcPercent(volume.totalInsCollectionVolume, (cumulativeStockData.cumulativeTotalInsMount + cumulativeStockData.maxTotalInsMount - cumulativeStockData.minTotalInsMount)),
            ...
            finInvDispersionRatio: calcPercent(volume.finInvCollectionVolume, (cumulativeStockData.cumulativeFinInvMount + cumulativeStockData.maxFinInvMount - cumulativeStockData.minFinInvMount)), 
            ...
            insurDispersionRatio: calcPercent(volume.insurCollectionVolume, (cumulativeStockData.cumulativeInsurMount + cumulativeStockData.maxInsurMount - cumulativeStockData.minInsurMount)),
            ...
            trustDispersionRatio: calcPercent(volume.trustCollectionVolume, (cumulativeStockData.cumulativeTrustMount + cumulativeStockData.maxTrustMount - cumulativeStockData.minTrustMount)),
            ...
            etcFinDispersionRatio: calcPercent(volume.etcFinCollectionVolume, (cumulativeStockData.cumulativeEtcFinMount + cumulativeStockData.maxEtcFinMount - cumulativeStockData.minEtcFinMount)),
            ...
            bankDispersionRatio: calcPercent(volume.bankCollectionVolume, (cumulativeStockData.cumulativeBankMount + cumulativeStockData.maxBankMount - cumulativeStockData.minBankMount)),
            ...
            pensDispersionRatio: calcPercent(volume.pensCollectionVolume, (cumulativeStockData.cumulativePensMount + cumulativeStockData.maxPensMount - cumulativeStockData.minPensMount)),
            ...
            sTrustDispersionRatio: calcPercent(volume.sTrustCollectionVolume, (cumulativeStockData.cumulativeSTrustMount + cumulativeStockData.maxSTrustMount - cumulativeStockData.minSTrustMount)),
            ...
            natDispersionRatio: calcPercent(volume.natCollectionVolume, (cumulativeStockData.cumulativeNatMount + cumulativeStockData.maxNatMount - cumulativeStockData.minNatMount)),
            ...
            etcDispersionRatio: calcPercent(volume.etcCollectionVolume, (cumulativeStockData.cumulativeEtcMount + cumulativeStockData.maxEtcMount - cumulativeStockData.minEtcMount)),
